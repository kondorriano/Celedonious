...
BlurContainer::BlurContainer() : noBlurDepth(vec2ui(0), TextureFormat::DEPTH_COMPONENT32) {
	noBlurColor0 = Texture2D(vec2ui(0), TextureFormat::RGBA8);
	...
	blurMaskColor0 = Texture2D(vec2ui(0), TextureFormat::RGBA8);
	...
	horitzontalBlurredColor0 = Texture2D(vec2ui(0), TextureFormat::RGBA8);
	...
	blurredColor0 = Texture2D(vec2ui(0), TextureFormat::RGBA8);
